...
public class fee extends Frame {
    ...
    fee()
    {
        ...
        l1.setBounds(550, 100, 240, 20);
  
        l2 = new JLabel(
            "Name of the Student:");
        l2.setBounds(50, 140, 250, 20);
  
        tf1 = new JTextField();
        tf1.setBounds(250, 140, 250, 20);
  
        l3 = new JLabel(
            "Name of the Father:");
        l3.setBounds(50, 180, 250, 20);
  
        tf2 = new JTextField();
        tf2.setBounds(250, 180, 250, 20);
  
        l4 = new JLabel("Roll Number:");
        l4.setBounds(50, 220, 250, 20);
  
        tf3 = new JTextField();
        tf3.setBounds(250, 220, 250, 20);
  
        l5 = new JLabel("Email ID:");
        l5.setBounds(50, 260, 250, 20);
        ...
        l7.setBounds(50,340, 250, 20);
  
        area1 = new JTextArea();
        area1.setBounds(250, 340, 250, 50);
  
        l9 = new JLabel("Gender:");
        l9.setBounds(50, 420, 250, 20);
        ...
        r5.setBounds(250, 420, 100, 30);
        r6.setBounds(350, 420, 100, 30);
        ...
        l10.setBounds(50, 460, 250, 20);
  
        tf6 = new JTextField();
        tf6.setBounds(250, 460, 250, 20);
        ...
        l14.setBounds(50, 640, 250, 20);
  
        tf8 = new JTextField();
        tf8.setBounds(250, 640, 250, 20);
  
        ImageIcon i2 = new ImageIcon("C:\\Users\\Ruchita\\Desktop\\1.png");
        JLabel l15
            = new JLabel("", i2, JLabel.CENTER);
  
        l15.setBounds(850, 50, 600, 200);
        ...
        list1.setBounds(600, 270, 125, 125);
        ...
        Receipt.setBounds(600, 410, 150, 30);
        JButton b2 = new JButton("Reset");
        b2.setBounds(750, 410, 150, 30);
        JButton Print = new JButton("Print");
        Print.setBounds(900, 410, 150, 30);
  
        area2 = new JTextArea();
        area2.setBounds(600, 450, 450, 240);
